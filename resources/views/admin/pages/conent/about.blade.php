                            ...
                            <form method="POST" action="{{ route('about.update', $content->id) }}"
                              enctype="multipart/form-data">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <label for="about_yt" class="form-label">About Youtube</label>
                                        <input type="text" class="form-control" id="about_yt" name="about_yt"
                                          value="{{ $content->about_yt }}" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="image" class="form-label">About Image 1</label>
                                        <input type="file" class="form-control dropify" id="image" name="about_image"
