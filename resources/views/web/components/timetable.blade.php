<section class="section bg-light" id="availability">
    <div class="container">
                    ...
                    <table class="table table-center table-bordered bg-white mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex mb-3">
                                        <img src="{{ asset('/') }}assets/web/images/doctors/01.jpg"
                                ...
                                <td>
                                    <div class="d-flex mb-3">
                                        <img src="{{ asset('/') }}assets/web/images/doctors/03.jpg"
                                            class="avatar avatar-md-sm rounded-circle border shadow"
                                            alt="">
                                        <div class="ms-3">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex mb-3">
                                        <img src="{{ asset('/') }}assets/web/images/doctors/02.jpg"
                                            class="avatar avatar-md-sm rounded-circle border shadow"
                                            alt="">
                                        <div class="ms-3">
                                ...
                                <td>
                                    <div class="d-flex mb-3">
                                        <img src="{{ asset('/') }}assets/web/images/doctors/05.jpg"
                                            class="avatar avatar-md-sm rounded-circle border shadow"
                                            alt="">
                                        <div class="ms-3">
                                ...
                                <td>
                                    <div class="d-flex mb-3">
                                        <img src="{{ asset('/') }}assets/web/images/doctors/04.jpg"
                                            class="avatar avatar-md-sm rounded-circle border shadow"
                                            alt="">
                                        <div class="ms-3">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex mb-3">
                                        <img src="{{ asset('/') }}assets/web/images/doctors/06.jpg"
                                            class="avatar avatar-md-sm rounded-circle border shadow"
                                            alt="">
                                        <div class="ms-3">
